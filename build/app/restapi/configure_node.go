...
//go:generate swagger generate server --target ../../app --name Node --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/node/build/templates --principal interface{}

func configureFlags(api *operations.NodeAPI) {
...
func configureAPI(api *operations.NodeAPI) http.Handler {
